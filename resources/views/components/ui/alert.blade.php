...
<div {{ $attributes->merge(['class' => "flex items-start gap-3 border rounded-xl px-4 py-3 text-sm $class"]) }}>
    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        {!! $icon !!}
    </svg>
    <div>{{ $slot }}</div>
</div>
